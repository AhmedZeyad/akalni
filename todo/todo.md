...
📁 Project Structure
 ...
 [ ]Create folders: models/, handlers/, repository/, middleware/
 [ ]Separate routes: /api/client/, /api/admin/, /api/restaurant/

🔐 Auth & Middleware

[ ]Extend existing middleware to support admin role
