...
type RestaurantRepo interface {
	...
	Search(query string, limit, offset int) (PaginationResponse, error)

	GetByID(id int64) (Restaurant, error)
	GetActive(limit, offset int) (PaginationResponse, error)
}
...
func (r *restaurantRepo) Search(term string, limit, offset int) (PaginationResponse, error) {
...
// NOTE: client
func (r *restaurantRepo) GetActive(limit, offset int) (PaginationResponse, error) {
	var restaurants []Restaurant
	var count int
	err := r.db.Select(&restaurants, `
	SELECT
